namespace Tefter
{
    ...
    public partial class CreateNewServiceBookFormOne : Form
    {
        ...
        private void Open_CreateNewServiceBookFormTwo_Button_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(PlateNumber_TextBox.Text.Trim()))
            {
            ...
            try
            {
                var carExists = dbContext.Cars.Find(carId);
                if (carExists != null)
                {
            ...
            var car = new Car(
                ...
                chassisNumber,
                engineNumber,
                workingVolumeCubicCm,
                firstRegistration,
                firstRegistrationInBG,
                fuelType,
                kilometers,
                owner,
                egn,
